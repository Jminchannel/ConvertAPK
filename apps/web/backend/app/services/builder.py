...
if _templates_dir_raw:
    ...
    _templates_candidate = PROJECT_ROOT / "templates" / "android"
    TEMPLATES_DIR = str(_templates_candidate) if _templates_candidate.exists() else ""
else:
    TEMPLATES_DIR = ""
DATA_VOLUME_TEMPLATE_SUBDIR = Path("ConvertAPK-Desktop") / "templates" / "android"
...
def _sync_android_templates_to_data_volume(on_log: Optional[Callable[[str], None]] = None) -> str:
    ...
    if not DATA_VOLUME:
        return ""
    source_root = PROJECT_ROOT / "templates" / "android"
...
class APKBuilder:
    ...
    def prepare_build(
        ...
        env = {
            ...
            "KEYBOARD_RESIZE": "true" if keyboard_resize else "false",
    ...
    def _run_build(self, task_id: str):
        ...
        try:
            ...
            env, task_output_dir = self.builder.prepare_build(
                ...
                keyboard_resize=getattr(task.config, "keyboard_resize", False),
