...
object AppConfig {
    ...
    /**
     * WebView UA 模式（android / pc）
     */
    val webViewUaMode: String =
        when (BuildConfig.WEBVIEW_UA.trim().lowercase()) {
            "pc", "desktop", "windows" -> "pc"
            else -> DEFAULT_WEBVIEW_UA
        }

    /**
     * Desktop UA（当选择 PC 模式时使用）
     */
    ...
    private const val DEFAULT_WEBVIEW_UA: String = "android"
}
