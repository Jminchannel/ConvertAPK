...
class APKBuilder:
    ...
    def prepare_build(
        ...
        env = {
            ...
            "HTML_LOCALIZE_RESOURCES": "true" if bool(html_localize_resources) else "false",
    ...
    def run_docker_build(
        ...
        try:
            ...
            cmd += [
                ...
                "-e",
                f"HTML_LOCALIZE_RESOURCES={env.get('HTML_LOCALIZE_RESOURCES', 'true')}",
                "-e",
    ...
    def _run_build(self, task_id: str):
        ...
        try:
            ...
            env, task_output_dir = self.builder.prepare_build(
                ...
                html_localize_resources=getattr(task.config, "html_localize_resources", True),
