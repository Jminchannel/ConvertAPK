...
export const messages = {
  'en': {
    ...
    config: {
      ...
      statusBarColorHint: 'Used when the status bar is visible. Hex colors such as #1E40AF are supported.',
  ...
  'zh-CN': {
    ...
    config: {
      ...
      statusBarColorHint: '状态栏显示时生效，支持 #1E40AF 这类十六进制颜色。',
  ...
  'zh-TW': {
    ...
    config: {
      ...
      statusBarColorHint: '狀態欄顯示時生效，支援 #1E40AF 這類十六進位顏色。',
