...
export const messages = {
  'en': {
    ...
    html: {
      ...
      modeFile: 'File',
      modeEdit: 'Edit',
      localizeToggle: 'Resource Localization',
      localizeHint: 'Download online assets and rewrite links to local files for offline use',
  ...
  'zh-CN': {
    ...
    html: {
      ...
      modeFile: '文件',
      modeEdit: '编辑',
      localizeToggle: '\u8d44\u6e90\u672c\u5730\u5316',
      localizeHint: '\u4e0b\u8f7d\u5728\u7ebf\u8d44\u6e90\u5e76\u6539\u5199\u4e3a\u672c\u5730\u5f15\u7528\uff0c\u652f\u6301\u79bb\u7ebf\u4f7f\u7528',
  ...
  'zh-TW': {
    ...
    html: {
      ...
      modeFile: '檔案',
      modeEdit: '編輯',
      localizeToggle: '\u8cc7\u6e90\u672c\u5730\u5316',
      localizeHint: '\u4e0b\u8f09\u7dda\u4e0a\u8cc7\u6e90\u4e26\u6539\u5beb\u70ba\u672c\u5730\u5f15\u7528\uff0c\u652f\u63f4\u96e2\u7dda\u4f7f\u7528',
