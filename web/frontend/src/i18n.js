...
messages.en.config.taskComplianceAckLabel = 'I confirm this task does not create app stores/markets or similar distribution apps, and does not involve phishing, impersonation, or malicious distribution.'
...
messages.en.config.clientFrozenByRisk = 'This client is frozen due to high risk: {reason}. Please contact developer to unfreeze.'

messages['zh-CN'].config.taskComplianceTitle = '合规确认'
messages['zh-CN'].config.taskComplianceAckLabel = '我确认本次任务不会制作应用商店/应用市场/分发平台类应用，且不用于钓鱼、仿冒、恶意分发等违法违规用途。'
...
messages['zh-CN'].config.clientFrozenByRisk = '当前客户端已被冻结：{reason}。请联系开发者解除冻结后再继续。'

messages['zh-TW'].config.taskComplianceTitle = '合規確認'
messages['zh-TW'].config.taskComplianceAckLabel = '我確認本次任務不會製作應用商店/應用市場/分發平台類應用，且不用於釣魚、仿冒、惡意分發等違規用途。'
...
messages['zh-TW'].config.clientFrozenByRisk = '目前客戶端已凍結：{reason}。請聯絡開發者解除凍結後再繼續。'
